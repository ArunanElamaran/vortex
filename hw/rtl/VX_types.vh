...
// PERF: tmem
`define VX_CSR_MPM_TMEM_READS           12'hB20     // tensor memory reads
`define VX_CSR_MPM_TMEM_READS_H         12'hBA0
`define VX_CSR_MPM_TMEM_WRITES          12'hB21     // tensor memory writes
`define VX_CSR_MPM_TMEM_WRITES_H        12'hBA1
`define VX_CSR_MPM_TMEM_BANK_ST         12'hB22     // tensor memory bank conflicts
