...
module VX_tensor_mem import VX_gpu_pkg::*; #(
...
`ifdef PERF_ENABLE
    ...
    assign tmem_perf.reads       = perf_reads;
    assign tmem_perf.writes      = perf_writes;
    assign tmem_perf.bank_stalls = perf_collisions;
    assign tmem_perf.crsp_stalls = perf_crsp_stalls;
